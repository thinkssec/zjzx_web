package com.slofzx.jbdf.base.util;

import com.slofzx.jbdf.base.util.algorithmImpl.BCConvert;
import com.slofzx.jbdf.base.util.algorithmImpl.StringImpl;
...
public class StringUtil {
     ...
     * @return
     */
    public static String parseNull(Object obj,String defaultValue){
    ...
    /**
     * 转换javabean属性字符串为数据库列名字符串，遇到大写字母
     * 用下划线分割
     * @param propertyString
     * @return
     */
    public static String changePropertyString2ColumnString(String propertyString){
        String result = "";
        String[] strArray = propertyString.split("(?<!^)(?=[A-Z])");
