 ...
 * @date 2017-06-27
 */
public class AppYqtsClfglq  extends DataEntity<AppYqtsClfglq> {
	 ...
	 * @return cgclfze
	 */
	@ExcelField(title="常规材料费总额（万元）", align=2,sort=4)
	public BigDecimal getCgclfze() {
		return cgclfze;
	}
	 ...
	 * @param cgclfze
	 */
	public void setCgclfze(BigDecimal cgclfze) {
		this.cgclfze = cgclfze;
	}
