...
<ul class="nav nav-tabs">
    <li class="active"><a href="">未批准机器认证</a></li>
    <%--<shiro:hasPermission name="cbgl:rgcblist2"><li><a href="${ctx}/cbgl/rgcblist">人工成本发布2</a></li></shiro:hasPermission>--%>
</ul>
<form:form id="searchForm" action="${ctx}/jqsq/listwpz" method="post" class="breadcrumb form-search" onsubmit="loading('正在载入，请稍等...');">
    <div style="margin-top:8px;">
        ...
        <input id="btnSubmit" class="btn btn-primary" type="button" onclick="sqdel();" value="删除"/>
    </div>
</form:form>
...
<script type="text/javascript">
    ...
    function sqdel(){
        ...
        $('#hid_c2').val(JSON.stringify(ttt));
        //console.log(JSON.stringify(ttt));
        $('#searchForm').attr("action",'${ctx}/jqsq/jqsqdel').submit();
    }
