	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand" style="padding-bottom: 0;padding-top: 0;vertical-align:middle "><img src="${ctxStatic}/login/img/logo.png" style="margin-bottom: 0px;margin-top:0px"/><span id="productName" style="vertical-align: middle">${fns:getConfig('productName')}</span></div>
				<ul id="userControl" class="nav pull-right">
<%--					<li><a href="#" target="_blank" title="访问主页"><i class="icon-home"></i></a></li>--%>
					...
					<li id="userInfo" class="dropdown"  style="line-height:30px">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame" style="line-height:30px"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
							<%--<li><a href="${ctx}/oa/oaNotify/self" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的通知 <span id="notifyNum2" class="label label-info hide"></span></a></li>--%>
						</ul>
					</li>
					<li  style="line-height:30px"><a href="${ctx}/logout" title="退出登录" >退出</a></li>
					<li>&nbsp;</li>
				</ul>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:right;">

						<c:set var="firstMenu" value="true"/>
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
								<li class="menu ${not empty firstMenu && firstMenu ? ' active' : ''}" style="line-height:30px">
