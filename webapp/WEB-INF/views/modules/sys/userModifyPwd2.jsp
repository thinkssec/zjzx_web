...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/user2/info">个人信息</a></li>
		<li class="active"><a href="${ctx}/sys/user2/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user2/modifyPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
