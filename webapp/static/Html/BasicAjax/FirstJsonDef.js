...

{
   Cfg: { 
      ...
      PrintPagePostfix:"<center style='width:%7px'>Page %1 horizontally from %4 , page %2 vertically from %5</center>", PrintPagePrefix:"<center style='width:%7px'>Printed page %3 from %6</center>", //Sample page header and footer 
      PrintPaddingHeight:"60", PrintPaddingWidth:"36",   // Reserved space for PrintPagePrefix / Postfix a and for default body margin and padding 
   ...
   Def: {
      ...
      // Footer summary rows 
      Foot: { CalcOrder:'D,B', XVisible:'0', EVisible:'0', FVisible:'0', HVisible:'0', IVisible:'0', TVisible:'0', CanFilter:'0', },

      // Row created when grouping rows 
      Group: { 
         Def:'Node', CanSelect:'0', AggChildren:'1', CanFilter:'2',
         XVisible:'0',
         ACanEdit:'1',
   ...
   // Column definition 
   LeftCols: [
      { Name:'X', Width:'51', Type:'Bool', CanFilter:'2', CanSort:'0' },                        // Used 
      { Name:'A', PrintWidth:'300', RelWidth:'100', MinWidth:'250', Width:'250', Type:'Text', ToolTip:'1', CanFilter:'2', CanHide:'0', SearchNames:'Product name,Product,Order name,Order' },  // Product / Order name 
      ],
   Cols: [
      { Name:'C', Width:'120', Type:'Text', CanEdit:'0', CanFilter:'2' },                       // Customer 
      { Name:'I', Width:'106', Type:'Date', Format:'d', CanEdit:'0', CanFilter:'2' },            // Date 
      { Name:'T', Width:'70', Type:'Enum', Enum:'|Comp|Access|Mon|Print|Soft', CanFilter:'2' }, // Kind 
      { Name:'D', Width:'90', Type:'Int', CanFilter:'2' },                                      // Amount 
      { Name:'E', Width:'93', Type:'Float', EditMask:'^\\-?\\d*\\.?\\d*$', Format:'0.00', CanFilter:'2', CanGroup:'0' },   // Unit price 
      { Name:'F', Width:'90', Type:'Float', Format:'0.00', Formula:'D*E', CanFilter:'2' },      // List price 
      { Name:'G', Width:'90', Type:'Int', Format:'0\\%', CanFilter:'2' },                       // Discount 
      { Name:'H', Width:'90', Type:'Float', Format:'0.00', CanFilter:'2' }                      // Shipping 
      ],
   RightCols: [
      { Name:'B', Width:'90', Type:'Float', Format:'0.00', Formula:'F-F*G/100+H', CanFilter:'2' }, // Price 
      ],
   ...
   Solid: [
      ...
      // Top tabber 
      { 
         Kind:"Tabber", id:"Tabber", Cells:"All,Y5,Y6,Y7,Y8,Y9,Cnt,Sel,Add,Del,Chg", Width:"40", CanFocus:"0", NoUpload:"0",
      ...
      { 
         ...
         WinOnChange:"Grid.NoVScroll = Value; Grid.NoHScroll = Value; if(!Value) { Grid.MainTag.style.width=''; Grid.MainTag.style.height='600px'; } Grid.Update();",
   ...
   Foot: [
      { 
         Def:'Foot', id:'Fix1', CanDelete:'0', CanEdit:'0', Calculated:'1', MenuName:'Total income',
         A:"Total income",
         BFormula:'sum("X==1")',
      ...
      { 
         Def:'Foot', id:'Fix2', CanDelete:'0', CanEdit:'0', Calculated:'1', MenuName:'Taxes',
         A:"Taxes",
      ...
      { 
         Def:'Foot', id:'Fix3', CanDelete:'0', CanEdit:'0', Calculated:'1', MenuName:'Profit',
         A:"Profit",
   ...
   Media: [
      { 
         ...
         Cols: [
            ...
            { Name:'A', MinWidth:'270' }, // Product / Order name
            { Name:'T', Width:'75' },     // Kind
            { Name:'D', Width:'105' },    // Amount
            { Name:'E', Width:'115' },    // Unit price
            { Name:'F', Width:'115' },    // List price
            { Name:'G', Width:'110' },    // Discount
            { Name:'H', Width:'110' }     // Shipping
            ]
         }
      ]
