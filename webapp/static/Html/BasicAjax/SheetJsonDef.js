...
Cfg: {
   id:"Sheet", SuppressCfg:"1", Sorting:"0", // Suppresses configuration and sorting 
...
DefCols: {
   Auto: { 
      Width:"90", CanPrint:"3", CanExport:"2", // Default width of all column 
      FormulaSuggest:"6"                       // For every column generates suggest list of all available formula functions to use in formula editing 
      }                  
   },
...
Foot: [
   { id:"ID", Index:" ", PanelType:"Text", Panel:"Name", ShowColNames:"1", Color:"#E5F3FA", CanFocus:"0", CanExport:"0", MenuName:"Column names (bottom)" }  // Informational bottom row with column names 
   ],
...
LeftCols: [
   ...
   { 
      Kind:"Panel", Name:"Panel", Copy:"1", Move:"1", // Places the panel right side to Index and shows add/copy button on it 
...
RightCols: [
    { Name:"id", Width:"50", Color:"#E5F3FA", CanFocus:"0", CanSelect:"0", CanDelete:"0", MenuName:"Row ids (right)", CanExport:"0", Align:"Center" }  // Informational right column with row ids 
   ],
